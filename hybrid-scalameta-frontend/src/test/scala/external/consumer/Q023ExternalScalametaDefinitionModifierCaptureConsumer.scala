...
object Q023ExternalScalametaDefinitionModifierCaptureConsumer:
  def flags(using q: Quotes)(target: q.reflect.DefDef): Unit =
    import quasiquotes.hybrid.q023.Q023FlagsScalametaPattern.dqq
  ...
  def structured(using q: Quotes)(target: q.reflect.DefDef): Unit =
    import quasiquotes.hybrid.q023.Q023StructuredScalametaPattern.dqq
  ...
  def symbol(using q: Quotes)(target: q.reflect.DefDef): Unit =
    import quasiquotes.hybrid.q023.Q023SymbolScalametaPattern.dqq
