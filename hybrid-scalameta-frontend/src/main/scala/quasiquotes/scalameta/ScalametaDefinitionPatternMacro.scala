    ...
    staticParts match
      ...
      case Some(parts) =>
        ScalametaDefinitionFrontend.classifyPatternParts(parts) match
          ...
          case Right(
                ScalametaDefinitionFrontend.PatternKind.CapturedModifiersNameMixedOrdinaryNamedUsingParameterSequencesCapturedResult
              ) =>
            '{
              ScalametaQuasiPattern
          ...
          case Right(
                ScalametaDefinitionFrontend.PatternKind.CapturedNameMixedOrdinaryNamedUsingParameterSequencesCapturedResult
              ) =>
            '{
              ScalametaQuasiPattern
          ...
          case Right(
                ScalametaDefinitionFrontend.PatternKind.CapturedModifiersNameMixedOrdinaryScala2ImplicitParameterSequencesCapturedResult
              ) =>
            '{
              ScalametaQuasiPattern
