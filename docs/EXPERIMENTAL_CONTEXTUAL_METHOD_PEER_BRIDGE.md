...
the disposable live AUXify build proof is specifically Scala 3.8.4. The source
build keeps `dottyInternal / publish / skip := true`, and no remote coordinate
containing this bridge exists unless a later release gate explicitly
authorizes one.
