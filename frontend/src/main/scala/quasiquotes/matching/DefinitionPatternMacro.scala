    ...
    staticParts match
      ...
      case Some(parts) =>
        DefinitionPattern.classifyStaticParts(parts) match
          ...
          case Right(
                DefinitionPattern.StaticPatternKind.CapturedNameNamedUsingParameterSequenceCapturedResult
              ) =>
            '{
              DefinitionPattern
          ...
          case Right(
                DefinitionPattern.StaticPatternKind.CapturedModifiersNameMixedOrdinaryNamedUsingParameterSequencesCapturedResult
              ) =>
            '{
              DefinitionPattern
                .capturedModifiersNameMixedOrdinaryNamedUsingParameterSequencesCapturedResultExtractor(
                  $context
                )(using $callerQuotes)
            }
          case Right(
          ...
          case Right(
                DefinitionPattern.StaticPatternKind.CapturedNameMixedOrdinaryScala2ImplicitParameterSequencesCapturedResult
              ) =>
            '{
              DefinitionPattern
          ...
          case Right(
                DefinitionPattern.StaticPatternKind.CapturedModifiersNameOrdinaryParameterSequenceCapturedResult
              ) =>
            '{
              DefinitionPattern
          ...
          case Right(
                DefinitionPattern.StaticPatternKind.CapturedNameOrdinaryParameterSequenceCapturedResult
              ) =>
            '{
              DefinitionPattern
