...
final class Q010TypedFixedAppliedDefinitionConstructionTest extends munit.FunSuite:
  ...
  test("current-Dotty direct and umbrella Definition hosts admit the fixed applied family"):
      ...
      def independentDefinition(tpe: TypeRepr): DefDef =
        ...
        DefDef(symbol, clauses =>
          clauses match
            ...
            case _ => report.errorAndAbort("Q010 current fixture lost its parameter")
        )
